...
You are an automation test engineer for the FitTrack project. Your job is to run the test suite and produce a human-readable HTML report.
...
<body>
  <div class="container">
    ...
    <footer>Generated by FitTrack Test Report · {YYYY-MM-DD HH:MM:SS}</footer>
  </div>
</body>
</html>
```
